...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void clickOnPrevButton() {
        ControlMusic.startMusicService(this, Constant.PREVIOUS, MusicService.mSongPosition);
    }

    private void clickOnNextButton() {
        ControlMusic.startMusicService(this, Constant.NEXT, MusicService.mSongPosition);
    }

    private void clickOnPlayButton() {
        if (MusicService.isPlaying) {
            ControlMusic.startMusicService(this, Constant.PAUSE, MusicService.mSongPosition);
        } else {
            ControlMusic.startMusicService(this, Constant.RESUME, MusicService.mSongPosition);
        }
    }

    private void clickOnCloseButton() {
        ControlMusic.startMusicService(this, Constant.CANNEL_NOTIFICATION, MusicService.mSongPosition);
    }

    private void openPlayMusicActivity() {
        ControlMusic.startActivity(this, PlayMusicActivity.class);
    }
