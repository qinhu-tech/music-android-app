...
public class PlaySongFragment extends Fragment implements View.OnClickListener {
    ...
    private void clickOnPrevButton() {
        ControlMusic.startMusicService(getActivity(), Constant.PREVIOUS, MusicService.mSongPosition);
    }

    private void clickOnNextButton() {
        ControlMusic.startMusicService(getActivity(), Constant.NEXT, MusicService.mSongPosition);
    }

    private void clickOnPlayButton() {
        if (MusicService.isPlaying) {
            ControlMusic.startMusicService(getActivity(), Constant.PAUSE, MusicService.mSongPosition);
        } else {
            ControlMusic.startMusicService(getActivity(), Constant.RESUME, MusicService.mSongPosition);
        }
    }
}
